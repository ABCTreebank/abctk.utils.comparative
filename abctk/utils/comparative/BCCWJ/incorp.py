...
IDX_READ_ALSO: dict[BCCWJSentIndex, tuple[BCCWJSentIndex]] = {
    BCCWJSentIndex( "LBf9_00090", 18640):(
        BCCWJSentIndex( "LBf9_00090", 18760),
    ),
    BCCWJSentIndex( "LBn9_00128", 15510):(
        BCCWJSentIndex( "LBn9_00128", 15580),
    ),
}

def get_real_text(idx: BCCWJSentIndex, real_texts: dict[BCCWJSentIndex, str], corpus_id: ABCTComp_BCCWJ_ID | str | None = None) -> str | None:
    ...
    if (
        ...
        logger.warning(
            f"Cannot find the real text for {corpus_id_str}"
        )
        return None